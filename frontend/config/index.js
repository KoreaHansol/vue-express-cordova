...
module.exports = {
  dev: {
    ...
    host: '49.167.66.58', // can be overwritten by process.env.HOST
    port: 49, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined
